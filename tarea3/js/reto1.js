...
function validation_alert(ptext) {
    swal.fire({
        ...
        html: ' <iframe src="https://lottie.host/embed/235126ed-eb64-49ec-b664-d9fdbee6be47/eXAdlrJQEp.json"></iframe> <br><p>' + ptext + " </p>",
    });
}
    ...
    if (error_count == 0) {
        if (user_input == username && pass_input == password) {
            Swal.fire({
                ...
                timer: 5000,
                html: '<iframe width="320" height="240" src="https://lottie.host/embed/9e1fb2dc-20c9-45ed-9e83-72fb538ddf70/B3oSZVxRdi.json"></iframe> <br><br><p>Recuerda que tus credenciales son: <br> Usuario:Cenfo <br> contraseña:123 </p>',
